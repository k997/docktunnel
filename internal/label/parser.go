// Copyright (c) The Traefik Authors.
//
...
//
// This file is derived from parser/labels_decode.go and parser/node.go of
// github.com/traefik/paerser, with the following modifications: added a guard
// that rejects label segments ending in "]" without a matching "[" (previously
// a slice-out-of-range panic), and expanded doc comments. The full Apache
// License, Version 2.0 text is reproduced in THIRD-PARTY-NOTICES.md.
